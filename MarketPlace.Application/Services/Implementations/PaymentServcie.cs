...
public class PaymentServcie : IPaymentServcie
{
    public PaymentStatus CreatePaymentRequest(string merchantId, int amount, string description,
    ...
    public PaymentStatus PaymentVerification(string merchatId, string authority, int amount, ref long refId)
    {
        var payment = new ZarinpalSandbox.Payment(amount);
