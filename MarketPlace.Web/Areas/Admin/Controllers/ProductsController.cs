        ...
        if (ModelState.IsValid)
        {
            ...
            if (result)
            {
                return JsonResponseStatus.SendStatus(
                    ...
                    "محصول مورد نظر با موفقیت رد شد",
                    reject
                    );
            }

            return JsonResponseStatus.SendStatus(JsonResponseStatusType.Danger, "محصول مورد نظر جهت عدم تایید را به درستی وارد نمایید", null);
        }
